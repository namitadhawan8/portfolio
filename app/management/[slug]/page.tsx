...
function ManagementCaseDetail({ managementCase }: ManagementCaseDetailProps) {
  return (
    <article className="bg-white dark:bg-zinc-950 dark:bg-zinc-950">
      {/* Hero Section */}
      <section className="border-b border-zinc-200 dark:border-zinc-700 dark:border-zinc-700">
      ...
      <section className="bg-zinc-50 dark:bg-zinc-900">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          <div className="relative overflow-hidden rounded-3xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-950 shadow-lg">
            <Image
      ...
      <section className="border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900">
        <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
          <div className="flex items-center justify-between">
            <Link
              href="/management"
              className="group inline-flex items-center gap-2 text-base font-semibold uppercase tracking-[0.2em] text-zinc-700 dark:text-zinc-300 transition-colors hover:text-[#B76BFC] dark:hover:text-[#B76BFC]"
            >
